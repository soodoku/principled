...
# Load data
pr			<- read.csv("xperceive/PartisanScandal/data/partisan_response/partisanresponse.csv")
...
# Save data
write.csv(pr, file="xperceive/PartisanScandal/data/partisan_response/pr.recode.csv")
