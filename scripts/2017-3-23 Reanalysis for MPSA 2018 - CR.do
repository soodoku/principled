...
insheet using "~/Dropbox/Ahler-Roush/Principled Partisan Animus/Data/AhlerSood/partisanresponse.csv", names clear

insheet using "C:\Users\car240\Dropbox\Ahler-Roush\Principled Partisan Animus\Data\AhlerSood\partisanresponse.csv", names clear
...
egen dem_trait_av_7=rowtotal(dems_sincere dems_open dems_compassionate dems_not_ignorant dems_not_smug dems_not_selfish dems_not_hypocritical)
gen dem_trait_av_7_st=dem_trait_av/6

egen reps_trait_av_7=rowtotal(reps_sincere reps_open reps_compassionate reps_not_ignorant reps_not_smug reps_not_selfish reps_not_hypocritical)
gen reps_trait_av_7_st=reps_trait_av_7/6
...
bys condition: sum dem_trait_av_7_st if pid_3==1
bys condition: sum reps_trait_av_7_st if pid_3==1
bys condition: sum dem_trait_av_7_st if pid_3==3
bys condition: sum reps_trait_av_7_st if pid_3==3


reg ft_dem reps_ignore reps_react dems_ignore dems_react if pid_3 == 1
reg ft_rep reps_ignore reps_react dems_ignore dems_react if pid_3 == 1
reg ft_dem reps_ignore reps_react dems_ignore dems_react if pid_3 == 3
reg ft_rep reps_ignore reps_react dems_ignore dems_react if pid_3 == 3


bys condition: sum dems_hypocritical if pid_3==1
bys condition: sum dems_hypocritical if pid_3==3

bys condition: sum reps_hypocritical if pid_3==3
bys condition: sum reps_hypocritical if pid_3==1
